...
root = Tk()
root.title("Moviinesh's Music Player")
...
organise_menu.add_command(label="Select folder with your music", command=load_music)
menu_bar.add_cascade(label="Organise", menu=organise_menu)

song_list = Listbox(root, bg="black", fg="white", width=100, height=15)
song_list.pack()

play_btn_img = PhotoImage(file="buttons_play.png")
prev_btn_img = PhotoImage(file="buttons_prev.png")
pause_btn_img = PhotoImage(file="buttons_pause.png")
next_btn_img = PhotoImage(file="buttons_next.png")
